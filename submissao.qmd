...
Ambos os arquivos devem ser anexados ao **Formulário de submissão** (Link: **em breve!** ) até às 23h59min do dia 26 de agosto de 2024. 

<!-- <center><a href="https://docs.google.com/forms/d/e/1FAIpQLSf3YTizMCqrKLIf9kHC7kUxH1_OX6kPDQ2lKkKN4CJGatIHSQ/viewform" target="_blank"><button type="button" class="btn btn-success">Acesse o formulário de <br> submissão! </button></center></a> -->
...
Em relação aos slides para as apresentações orais, os autores podem utilizar a formatação de sua preferência, podendo incluir os logotipos do evento disponíveis para download no site. 
