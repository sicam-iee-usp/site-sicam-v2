...
Em relação aos slides para as apresentações orais, os autores podem utilizar a formatação de sua preferência, podendo incluir os logotipos do evento. 

Acesse o [template para o pôster](https://github.com/sicam-iee-usp/site-sicam-v2/raw/main/template_poster.pdf).
